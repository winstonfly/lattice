...
func TestStateMachine_ValidTransitions(t *testing.T) {
	tests := []struct {
		...
		{"probing→relay-ready", StateProbing, StateRelayReady, false},
		{"probing→failed", StateProbing, StateFailed, false},
		{"relay-ready→ice-ready", StateRelayReady, StateICEReady, false},
		{"relay-ready→failed", StateRelayReady, StateFailed, false},
		{"relay-ready→closed", StateRelayReady, StateClosed, false},
		...
		{"ice-ready→relay-ready", StateICEReady, StateRelayReady, true},
